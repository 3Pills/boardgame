                ...
                @if(\Auth::user())
                    <li role="presentation" class="dropdown">
                        <a id="profile-link" type="button" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" href="{{ \URL::to('/user/'.\Auth::user()->url) }}">
                            ...
                            <img src="{{url('/assets/images/').(file_exists('./assets/images/avatars/'.\Auth::user()->url.'.jpg') ? '/avatars/'.\Auth::user()->url.'.jpg' : '/default-avatar.png')}}" alt="avatar", class = "img-rounded navbar-profile")/>
                        </a>
